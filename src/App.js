    ...
    <div id="home">
      ...
      <section id="about" name="about" class="about-section text-center">
        <div class="container">
          ...
          <img src="img/ipad.png" class="img-fluid" alt=""></img>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto text-center">
              ...
              <form class="form-inline d-flex">
                <input type="email" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputEmail" placeholder="Enter email address..."></input>
